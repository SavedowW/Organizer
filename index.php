                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="width: 4vh">
                                ...
                                <a href="exitLogin.php" id="admin-menu-exit" class="admin-menu-exit" onclick="exitUser();" style="display: none;">
                                ...
                                <div id="tabsmain">
                                                                        ...
                                                                        <table class="taskLine">
                                                                            <tbody>
                                                                                <tr class="taskSection">
                                                                                    ...
                                                                                    <td>
                                                                                        <a href="#" style="display: block;" id="taskSettingsBtn" onclick="settingsBtn(this);">
                                    ...
                                    <div id="tabs-priorities" class="ui-tabs-panel" style="display:none;">
                                        <div id="priorities" >
                                            ...
                                            <div class="form" id="formPriority" style="display: none;">
                                                <div class="comparers">
                                                    <div id="hightTasksPriority">
                                                        <p>Высокий приоритет:</p>
                                                        <div id="hightTaskContainer"></div>
                                                    </div>
                                                    <div id="mediumTasksPriority">
                                                        <p>Средний приоритет:</p>
                                                        <div id="mediumTaskContainer"></div>
                                                    </div>
                                                    <div id="lowTasksPriority">
                                                        <p>Низкий приоритет:</p>
                                                        <div id="lowTaskContainer"></div>
                                                    </div>
                                                    <div id="unknownTasksPriority">
                                                        <p>Неизвестный приоритет:</p>
                                                        <div id="unknownTaskContainer"></div>
                                                    </div>
                                                </div>
